...
public class CardDiceView extends VBox {
    ...
    public CardDiceView(Runnable diceAction) {
        super(30);
        System.out.println("CardDiceView créé");
    ...
    private void createComponents(Runnable diceAction) {
        ...
        card = new FlipCard("fr/pierrickviret/javaquest/javafx/assets/warrior.PNG", "fr/pierrickviret/javaquest/javafx/assets/dice.png");

        actionButton = new Button("Retourner la carte");
        ThemeConfig.applyButtonStyle(actionButton);

        card.setOnFlipComplete(() -> {
            titre.setText("Lancez le dé");
