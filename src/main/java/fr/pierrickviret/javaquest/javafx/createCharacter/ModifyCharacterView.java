...
public class ModifyCharacterView extends VBox {
    ...
    public ModifyCharacterView(MainCharacter character) {
        ...
        warrior = createButton("/fr/pierrickviret/javaquest/assets/Character/warrior.PNG", type == CharacterType.Warrior , () -> {
        ...
        wizard = createButton("/fr/pierrickviret/javaquest/assets/Character/wizard.PNG",type == CharacterType.Wizard,  () -> {
